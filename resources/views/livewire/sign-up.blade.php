<form wire:submit="submit" class="space-y-5">
    ...
    <div>
        ...
        <input wire:model="password_confirmation" type="password" placeholder="Repeat your password"
               class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent transition-all">
    </div>
